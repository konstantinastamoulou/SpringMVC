				...
				<table class="table table-hover">
					...
					<c:forEach items="${documents}" var="doc" varStatus="counter">
						<tr>
							...
							<td>${doc.filename}</td>
							<td><img class="doc" src="<c:url value='/get-document/${doc.id}' />"/></td>
							<td><a href="<c:url value='/download-document/${appartment.id}/${doc.id}' />" class="btn btn-success custom-width">download</a></td>
							<td><a href="<c:url value='/delete-document/${appartment.id}/${doc.id}' />" class="btn btn-danger custom-width">delete</a></td>
						</tr>
					</c:forEach>
		    		</tbody>
		    	</table>
